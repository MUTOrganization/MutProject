  ...
  return (
    <Card className="flex flex-col w-full mx-auto bg-custom-gradient shadow-none border border-separate p-3 lg:p-7 h-[calc(100vh-8rem)]">
      <div className="flex flex-col flex-grow overflow-y-auto scrollbar-hide">
        ...
        <div
          className={`flex-grow transition-transform duration-500`}
        >
          <section
          ...
          >
            ...
            <div className="flex flex-col max-sm:items-center max-sm:w-full">
              <div className="text-6xl max-lg:text-5xl grid sm:grid-cols-2">
              ...
              <div className="text-6xl max-lg:text-5xl font-bold grid sm:grid-cols-2">
            ...
            {/* Right Column */}
            <div className="flex p-0 relative mr-4 mt-4 max-lg:hidden">
              <img
