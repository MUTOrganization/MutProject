...
function AllSummary({ expensesData, commissionData, isLoading }) {
    ...
    return (
        <div className='w-full flex flex-row justify-start items-center space-x-5'>
            ...
            <div className='bg-white rounded-lg py-2 px-6 flex flex-row justify-between items-center space-x-8 relative h-28 border-3 border-slate-50'>
                ...
                <div className='subBox2'>
                    ...
                    <div className='mt-3'>
                        <div className='text-2xl'>{isLoading || commissionData.length === 0 ? <Spinner variant='gradient' size='sm' color='danger' /> : formatNumber(totalSales)}</div>
                    </div>
                </div>
                ...
                <div className='subBox1'>
                    ...
                    <div className='mt-4 flex flex-col justify-center items-start py-4'>
                        <div className='text-2xl'>{commissionData.length === 0 ? <Spinner variant='gradient' size='sm' color='danger' /> : formatNumber(expensesNetAmount)}</div>
                        <div className='text-sm text-slate-500'></div>
                    </div>
                </div>
            </div>

            <div className='bg-white rounded-lg py-3 px-6 h-28 flex flex-row justify-between items-center space-x-8 relative  border-3 border-slate-50'>
                <div className='subBox2 px-4'>
                    ...
                    <div className='flex flex-col justify-center items-start mt-8'>
                        <div className='text-slate-500 text-2xl'>{isLoading || commissionData.length === 0 ? <Spinner variant='gradient' size='sm' color='danger' /> : formatNumber(totalCommission)}</div>
                ...
                <div className='subBox2 px-4'>
                    ...
                    <div className='flex flex-col justify-center items-start mt-8'>
                        <div className='text-slate-500 text-2xl'>{isLoading ? <Spinner color='danger' variant='gradient' size='sm' /> : formatNumber(totalExpenses)}</div>
            ...
            <div className='bg-white rounded-lg px-4 py-5 h-28 flex flex-col justify-center items-center space-y-2 w-full  border-3 border-slate-50'>
            ...
            <div className='bg-white rounded-lg px-4 py-5 h-28 w-full relative  border-3 border-slate-50'>
                ...
                <div className='mt-4 flex flex-row justify-center items-start py-4'>
                    <div className='text-2xl'>{commissionData.length === 0 ? '' : commissionData.reduce((sum, item) => sum + item.data.reduce((acc, item) => acc + item?.orderCount, 0), 0)}</div>
                    <div className='text-sm text-slate-500'></div>
                </div>
            </div>
        </div>
