...
function ViewpersonalBox1({ thisYear, firstYear, selectYear, setSelectYear, isSwitch }) {
    const months = [
        'มกราคม',
        'กุมภาพันธ์',
        'มีนาคม',
    ...
    return (
        <div className='w-5/12 bg-white p-5 border-2 border-slate-100 rounded-md h-full'>
            {/* header */}
            <div className='profile flex flex-row items-start space-x-4'>
                <div className='image w-4/12 h-32 rounded-md bg-slate-300 flex items-center justify-center'>Image</div>
                <div>
...
export default ViewpersonalBox1
