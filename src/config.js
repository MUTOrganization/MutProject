...
export const URLS = {
  ...
  okr : {
    getGradeSetting : `${BASE_URL_PROD}/okr/getGradeSettings`, // GET query {businessId,year}

    updateGradeSetting : `${BASE_URL_PROD}/okr/updateGradeSetting`, // POST body {businessId , year ,grades}
  },
